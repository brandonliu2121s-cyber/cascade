...
import { DisruptionPlanner } from "../components/DisruptionPlanner";
...
export default function WhatIf() {
  ...
  const [disruptionWorking, setDisruptionWorking] = useState(false);
  ...
  async function simulate() {
    if (!instance || !current || working || busy || disruptionWorking) return;
  ...
  function apply() {
    if (!preview || preview.baseRevision !== revision || busy || working || disruptionWorking) return;
